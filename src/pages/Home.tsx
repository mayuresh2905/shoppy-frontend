...
import { FaHeadset, FaAnglesDown } from "react-icons/fa6";
  ...
  return (
    ...
    <div className="home">
      ...
      <div>
        ...
        <video className="video-background" autoPlay loop={false} muted src={Banner} ref={videoRef}/>
      </div>
      <h1>Latest Products
